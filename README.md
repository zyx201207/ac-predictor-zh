...
添加`在比赛开始前显示rating`等实用的功能，并对 rating 变化箭头进行了美化，比赛排行榜可以使用两种不同的风格来显示rating变化，优化了错误处理，错误处理的灵感源自 ac-predictor-cn-ez，感谢 [@Gary0](https://github.com/gary-0925)，对大部分内容进行了汉化。
